...
async function GET() {
    try {
        ...
        const { count: studentsCount, error: studentsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('students').select('*', {
            count: 'exact',
            head: true
        });
        // Fetch teachers count
        const { count: teachersCount, error: teachersError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('teachers').select('*', {
            count: 'exact',
            head: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1001e758._.js.map