...
"[project]/app/api/parent/link-student/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { parent_id, student_number, relationship_type } = body;
        if (!parent_id || !student_number) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Parent ID and Student Number are required'
            }, {
                status: 400
            });
        }
        ...
        const { data: student, error: studentError } = await supabaseAdmin.from('users').select('id, first_name, last_name, student_number, grade_level, section, email').eq('student_number', student_number).eq('role', 'student').single();
        if (studentError || !student) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Student not found with this student number'
            }, {
                status: 404
            });
        }
        // Check if relationship already exists
        const { data: existing } = await supabaseAdmin.from('user_relationships').select('id').eq('user_id', parent_id).eq('related_user_id', student.id).single();
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        // Create relationship
        const { error: insertError } = await supabaseAdmin.from('user_relationships').insert({
            user_id: parent_id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43a41108._.js.map